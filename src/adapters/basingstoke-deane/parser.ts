/**
 * Basingstoke & Deane Borough Council - Response Parser
 * 
 * Parses untrusted upstream responses (HTML or JSON) into normalised events.
 * 
 * @module adapters/basingstoke-deane/parser
 */
...
import type {
  BasingstokeRawResponse,
  BasingstokeCollection,
  BasingstokeAddress,
  BasingstokeHtmlData,
} from './types.js';

/**
 * Map Basingstoke service names to canonical ServiceType enum.
 */
...
/**
 * Parse date from Basingstoke format.
 */
...
/**
 * Parse individual Basingstoke collection into CollectionEvent.
 */
export function parseCollectionEvent(
  raw: BasingstokeCollection,
  index: number
...
/**
 * Parse Basingstoke response into collection events.
 */
export function parseCollectionEvents(
  response: BasingstokeRawResponse | BasingstokeHtmlData
): CollectionEvent[] {
...
/**
 * Parse address candidates from Basingstoke address lookup.
 */
export function parseAddressCandidates(
  addresses: BasingstokeAddress[],
  postcode: string
): AddressCandidate[] {
